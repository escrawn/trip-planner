        ...
        <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <button
                    ...
                    className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white font-semibold py-2 sm:py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2 text-sm sm:text-base"
                >
                    {isLoading ? (
                        <>
